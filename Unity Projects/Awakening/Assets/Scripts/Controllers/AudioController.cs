...
public class MusicSettings
{
	...
	public float combatFadeDuration, fadeDuration;
}
...
public class AudioController : MonoBehaviour
{
	...
	{
		AudioClip clip;
		float fadeDuration = musicSettings.fadeDuration;
		if (gc != null && Enemy.IsInCombat())
		{
			int i;
			do
			{
			...
			fadeDuration = musicSettings.fadeDuration;
		}
		else
		{
			int i;
